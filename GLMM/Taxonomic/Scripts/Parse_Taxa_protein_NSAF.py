# This script is used for parsing the Taxonomic name file with NSAF from protein databasae searching
...
# Example usage
taxa_file_path = '/ourdisk/hpc/prebiotics/dywang/Projects/CHOICE/Metaproteome/Taxa/Maternal/Maternal_TaxtaPro.txt'
csv_directory = '/ourdisk/hpc/prebiotics/dywang/Projects/CHOICE/Metaproteome/Overall/NSAF_Maternal/'
output_file_path = '/ourdisk/hpc/prebiotics/dywang/Projects/CHOICE/Metaproteome/Overall/GLMM_taxa/Maternal/Maternal_taxa.csv'
