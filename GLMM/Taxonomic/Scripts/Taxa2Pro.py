...
input_file_path = '/ourdisk/hpc/prebiotics/dywang/Projects/CHOICE/Metagenome/Kaiju/Maternal/Taxa_name/Taxa_Maternal.txt'
# Replace 'output_file_path' with the path where you want to save the output file
output_file_path = '/ourdisk/hpc/prebiotics/dywang/Projects/CHOICE/Metagenome/Kaiju/Maternal/Taxa_name/Maternal_TaxtaPro.txt'
